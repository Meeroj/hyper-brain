      ...
      <div className="mt-8">
        <ul>
          <li>
            <NavLink 
              to="home" 
              className={({ isActive }) => `flex items-center p-3 text-xl pr-0 my-2 rounded-s-lg relative pe-2 ${isActive ? 'bg-[hsl(var(--background))] text-[hsl(var(--foreground))] active-link' : 'hover:bg-secondary hover:text-secondary-foreground'}`}>
              <Layout className="mr-2"/>Home
            </NavLink>
          </li>
          <li>
            <NavLink 
          ...
          <li>
            <NavLink 
              to="learning" 
              className={({ isActive }) => `flex items-center p-3 text-xl pr-0 my-2 rounded-s-lg relative pe-2 ${isActive ? 'bg-[hsl(var(--background))] text-[hsl(var(--foreground))] active-link' : 'hover:bg-secondary hover:text-secondary-foreground'}`}>
              <Library className="mr-2"/>Learning
            </NavLink>
          </li>
          <li>
            <NavLink 
              to="battle" 
              className={({ isActive }) => `flex items-center p-3 text-xl pr-0 my-2 rounded-s-lg relative pe-2 ${isActive ? 'bg-[hsl(var(--background))] text-[hsl(var(--foreground))] active-link' : 'hover:bg-secondary hover:text-secondary-foreground'}`}>
              <Swords className="mr-2"/>Battle
            </NavLink>
          </li>
        </ul>
      </div>
      <div className="absolute bottom-0 left-0 w-full p-2 z-50" id="account-setting">
        <div className="flex">
        <SignedIn >
          <UserButton 
